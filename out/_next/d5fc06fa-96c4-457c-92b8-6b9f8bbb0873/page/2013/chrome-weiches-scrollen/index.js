window.__NEXT_REGISTER_PAGE('/2013/chrome-weiches-scrollen', function() {
        ...
        o.default = function() {
          return c.default.createElement(
            ...
            c.default.createElement(
              i.default,
              null,
              'Somit war es nur notwendig, in einem neuen Tab',
              ' ',
              c.default.createElement(d.InlineCode, null, 'chrome://flags'),
              ' ',
              'einzugeben, enter zu drücken, und auf der geladenen Seite den Bereich ',
              '"',
              'Optimiertes Scrollen',
              '"',
              ' zu suchen. Sobald dieser dann gefunden ist, dort einfach auf ',
              '"',
              'Aktivieren',
              '"',
              ' klicken, und den Browser neu starten. Und schon klappt es - das ',
              '"',
              'weiche',
              '"',
              ' Scrollen.'

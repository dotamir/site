window.__NEXT_REGISTER_PAGE('/2013/responsive-designs', function() {
        ...
        function a(l, o, e, r, c) {
          function s(l, o) {
            ...
            if ((r = S(M, o))) {
              ...
              do {
                M.className && x(), (Q += M.relevance), (M = M.parent)
              } while (M !== r.parent)
              return (
                t.excludeEnd && g(o, B),
                (U = k),
          ...
          try {
            ...
            return { relevance: Q, value: B, language: l, top: M }
          } catch (l) {
      ...
      489: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            i.default,
            null,
            c.default.createElement(b.default, { id: 'responsive-designs' }),
            ...
            c.default.createElement(
              ...
              '"',
              ' ',
              'einigermaßen gut zu beherrschen, denn darauf baut sich die ganze Optimierung des Designs auf. Jedes Design, das responsive ist, arbeitet mit sogenannten Media-Queries, welche seit der dritten CSS-Version auf fast allen Browsern verfügbar sind.'
            ),
            c.default.createElement(
              j.default,
              null,
              'Das ganze Verfahren lässt sich wohl am besten durch verschiedene Beispiele erklären. Die folgenden Codes können ganz einfach und ohne Probleme im CSS-Code der eigenen Webseite eingebettet werden.'
            ),
            c.default.createElement(
              j.default,
              null,

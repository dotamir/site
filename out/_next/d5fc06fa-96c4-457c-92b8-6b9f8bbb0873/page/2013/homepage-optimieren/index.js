window.__NEXT_REGISTER_PAGE('/2013/homepage-optimieren', function() {
        ...
        o.default = function(l, o) {
          return function(e) {
            var r = e.language,
              ...
              M = void 0 === C ? 'code' : C,
              B = e.code,
              N = void 0 === B ? (Array.isArray(t) ? t[0] : t) : B,
              D = (0, f.default)(e, [
                'language',
                'children',
                'style',
            ...
            var L =
              r && l.getLanguage(r) ? l.highlight(r, N) : l.highlightAuto(N)
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, r, c) {
          function s(l, o) {
            ...
            if ((r = P(M, o))) {
              ;(t = M), t.returnEnd || t.excludeEnd || (U += o), u(h(), N)
              do {
                M.className && E(), (F += M.relevance), (M = M.parent)
              } while (M !== r.parent)
              return (
                t.excludeEnd && g(o, N),
                (U = k),
          ...
          function P(l, o) {
            ...
            if (l.endsWithParent) return P(l.parent, o)
          }
          function x(l, o) {
          ...
          function j(l, e, t, c) {
            ...
            try {
              ...
              for (p(e.substr(M)), v = w; v.parent; v = v.parent)
                v.className && (W += x)
              return { relevance: P, value: W, language: l, top: w }
            } catch (l) {
          ...
          function b(l) {
            return E.tabReplace || E.useBR
              ? l.replace(S, function(l, o) {
                  return E.useBR && '\n' === l
                    ? '<br>'
                    : E.tabReplace ? o.replace(/\t/g, E.tabReplace) : ''
                })
              : l
          }
          function f(l, o, e) {
      ...
      473: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            i.default,
            null,
            c.default.createElement(b.default, { id: 'homepage-optimieren' }),
            ...
            c.default.createElement(
              ...
              c.default.createElement(
                g.default,
                { href: 'http://www.frewhost.net' },
                'Hosting-Projekt'
              ),
              ' ',
              'den sogenannten OpenGraph, welcher von Facebook verwendet wird, sowie Windows 8 vorgenommen. Um eine Optimierung vorzunehmen, ist natürlich ein Zugriff auf die Datein der jeweiligen Homepage vonnöten. Dann kann es aber auch schon mit der Optimierung los gehen:'
            ),
            c.default.createElement(
              j.default,
              null,
              'Facebook bietet glücklicherweiße einen Generator, indem im Grunde nurnoch die nötigen Informationen bereitgestellt werden müssen, bevor der fertige Code in den Head-Bereich der eigenen Webseite eingebaut werden kann. Dieser ist seit einigen Monaten im ',
              c.default.createElement('b', null, 'zweiten Teil'),
              ' der offiziellen',
              ' ',
              c.default.createElement(
                g.default,
            ...
            c.default.createElement(
              j.default,
              null,
              'Zunächst wird der Titel der Seite gesetzt, dann die Hintergrundfarbe der Vorschau, und zuletzt die Grafik, welche dargestellt werden soll. Bei dieser ist eine Größe von 250 x 250 Pixeln sowie die Dateiendung ',
              '"',
              '.png',
              '"',
              ' optimal.'

window.__NEXT_REGISTER_PAGE('/2015/mvps-web', function() {
          ...
          return function(e) {
            ...
            return g.default.createElement(
              ...
              g.default.createElement(
                M,
                u,
                x({ rows: q, stylesheet: a, useInlineStyles: p })
              )
            )
          }
        }
        ...
        function a(l) {
          ...
          if (u) {
            var m = s(e, n),
              ...
              y = m(o.children)
            return f.default.createElement(u, (0, d.default)({ key: h }, p), y)
          }
        }
        Object.defineProperty(o, '__esModule', { value: !0 })
        var n = e(6),
      ...
      13: function(l, o, e) {
        ...
        function s(l, o) {
          var e = (x[l] = o(u)),
            ...
            r = t && t.length,
            c = -1
          for (E.push(l); ++c < r; ) S[t[c]] = l
        }
        function a(l, o, e, t, c) {
          function s(l, o) {
            var e, t, r
            if (((U += l), void 0 === o)) return u(h(), N), 0
            if ((e = S(o, M)))
              return u(h(), N), n(e, o), e.returnBegin ? 0 : o.length
            if ((t = E(M, o))) {
              ;(r = M), r.returnEnd || r.excludeEnd || (U += o), u(h(), N)
              do {
          ...
          function h() {
            var l = void 0 === M.subLanguage ? b() : j()
            return (U = k), l
          }
          function j() {
            var l,
              o = 'string' == typeof M.subLanguage
            return o && !x[M.subLanguage]
              ? g(U, [])
              : ((l = o
          ...
          function E(l, o) {
            ...
            if (l.endsWithParent) return E(l.parent, o)
          }
          function S(l, o) {
        ...
        function f(l) {
          return (l = l.toLowerCase()), x[l] || x[S[l]]
        }
        var b = e(14)
        t.prototype = b
        var u = new t()
        ...
        !(function(l) {
          ...
          function d(l, e, r, c) {
            ...
            function b() {
              ...
              for (
                r = '',
                  ...
                  t = w.lexemesRe.exec(O);
                t;

              )
                (r += o(O.substring(e, t.index))),
                  (l = i(w, t)),
                  l ? ((E += l[1]), (r += f(l[0], o(t[0])))) : (r += o(t[0])),
                  (e = w.lexemesRe.lastIndex),
                  (t = w.lexemesRe.exec(O))
              return r + o(O.substr(e))
            }
            function u() {
              var l = 'string' == typeof w.subLanguage
              if (l && !_[w.subLanguage]) return o(O)
              var e = l
                ? d(w.subLanguage, O, !0, A[w.subLanguage])
                : j(O, w.subLanguage.length ? w.subLanguage : void 0)
              return (
                w.relevance > 0 && (E += e.relevance),
            ...
            function p(l, o) {
              ...
              if (t) {
                ...
                r.skip
                  ? (O += o)
                  : (r.returnEnd || r.excludeEnd || (O += o),
                    g(),
                    r.excludeEnd && (O = o))
                do {
                  w.className && (W += S),
                    w.skip || (E += w.relevance),
                    (w = w.parent)
                } while (w !== t.parent)
            ...
            try {
              for (var x, C, M = 0; ; ) {
                if (
                  ((w.terminators.lastIndex = M), !(x = w.terminators.exec(e)))
                )
                  break
                ;(C = p(e.substring(M, x.index), x[0])), (M = x.index + C)
              }
              for (p(e.substr(M)), v = w; v.parent; v = v.parent)
                v.className && (W += S)
              return { relevance: E, value: W, language: l, top: w }
            } catch (l) {
          ...
          function u(l) {
            ...
            r(h) ||
              ...
              (t.value = f(t.value)),
              (l.innerHTML = t.value),
              (l.className = b(l.className, h, t.language)),
      ...
      544: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            i.default,
            null,
            c.default.createElement(f.default, { id: 'mvps-web' }),
            c.default.createElement(
              d.default,
              null,
              'If you',
              "'",
              're following me on Twitter, you',
              "'",
              've probably already noticed that I have recently been doing a lot of development for Dave Hakkens, a smart guy from the Netherlands who likes inventing new products, traveling the world and sharing his experiences with the rest of the world using short films which he',
              "'",
              's posting on his',
              ' ',
              c.default.createElement(
                u.default,
                { href: 'https://www.youtube.com/user/hakopdetak' },
                'YouTube channel'
              ),
              '.'
            ),
            c.default.createElement(
              d.default,
              null,
              'A few months ago, he decided that his personal site would need an update and therefore simply asked his Twitter followers for help. Back then, I already knew about his biggest project: Phonebloks (because so many other people were talking about it), but I didn',
              "'",
              't yet knew him, the person behind all that stuff. Thankfully, some of the people I was following at that time decided to share his tweet.'
            ),
            c.default.createElement(
              d.default,
              null,
              'Then everything went pretty fast. I',
              "'",
              've emailed him, he wrote back and we scheduled a Skype call for a few days later. When the day was finally there, I was very excited about finally talking English to someone else, rather than just chatting through text. Since my personal room was relatively dark back then (not much sunlight) and I had thought that we were going to do video chatting, I',
              "'",
              've moved all my stuff into our living room, where it was very bright and much happier to look at.'
            ),
            c.default.createElement(
              d.default,
              null,
              'But to my relief, we both agreed to just talk. At first, he asked me a lot of things: When I started developing websites, what I had made so far and how such a creation-process will even work. I',
              "'",
              've tried to explain everything as detailed as I could and managed to convince him that I was the right one for the job! After clicking the red button to end the chat, I was like: ',
              '"',
              'Hell yeah, I',
              "'",
              'm going to develop a site for the creator of Phonebloks',
              '"',
              '.'
            ),
            c.default.createElement(
              ...
              'Although it',
              "'",
              's a very good story to tell you about, it',
              "'",
              's not the only thing this article will be about. Rather than that, I',
              "'",
              'd like to present you a different way of creating products, than the usual one. It',
              "'",
              's neither new, nor does it come from the web. But I know for sure that we can apply it to many of our products, too!'
            ),
            c.default.createElement(
              g.H2,
              null,
            ...
            c.default.createElement(
              d.default,
              null,
              'For a long time, the exact opposite was my personal mantra: The faster, the better. I',
              "'",
              've tried so hard to constantly improve my products, while others only contributed to them irregularly.'
            ),
            c.default.createElement(
              d.default,
              null,
            ...
            c.default.createElement(
              d.default,
              null,
              'Believe me, or not: I already wanted to work like this. I wanted to save more time for all the small details, because I really love what I',
              "'",
              'm doing. But I couldn',
              "'",
              't. Because I didn',
              "'",
              't know how. I knew about the goal, but not which way I needed to go to reach it. There was no concept, no foundation. Just me wanting to achieve something I couldn',
              "'",
              't reach at that time.'
            ),
            c.default.createElement(
              d.default,
              null,
            ...
            c.default.createElement(g.H2, null, 'In Practice'),
            c.default.createElement(
              d.default,
              null,
              'Dave',
              ...
              c.default.createElement(
                u.default,
                { href: 'http://story-hopper.com' },
                'Story Hopper'
              ),
              ', was the perfect chance to test out this way of developing products.'
            ),
            c.default.createElement(
              d.default,
              null,
              'Since I was still working while creating his site, I sadly didn',
              "'",
              't had enough time to implement the rating system, which could enable visitors to rate each movie with a certain amount of stars, depending on how much they like it. On the other hand, the time would have been enough if I had simply chosen to go with one of those existing rating plugins for WordPress, instead of building my own one. But since it was already such a beautiful site, I didn',
              "'",
              't want to add one of those crappy plugins to it.'
            ),
            c.default.createElement(
              d.default,
              null,
              'What can I say? Dave really liked the idea of me building a completely new rating system just for his project. The only thing that I didn',
              "'",
              't like, was that it would have taken much more time. And since he had already announced that the site will launch on October 5, there was no way around it.'
            ),
            c.default.createElement(
              d.default,
              null,
              'But I didn',
              "'",
              't wanted to just led this idea die. We were both very excited about a custom rating functionality, but we also didn',
              "'",
              't wanted to delay the launch. I mean, over 50.000 people (Dave',
              "'",
              's followers on Twitter) had already seen his announcement and we simply couldn',
              "'",
              't just leave them out in the cold.'
            ),
            c.default.createElement(
              d.default,
              null,
              'I',
              "'",
              've spent a few hours stretching my brain cells and worked out a approach which would allow us to launch the site on the announced date while avoiding a broken website, all this with the so-called',
              ' ',
              c.default.createElement(
                u.default,
                {
            ...
            c.default.createElement(
              ...
              'So what did you do?',
              '"',
              ', you might ask. Great question! And the answer is: Very less, but effective work.'
            ),
            c.default.createElement(
              d.default,
              null,
              ...
              't much time left, I',
              "'",
              've decided to code a script which allows each visitor to rate every video based on the already existing 5-star-scala. But because the backend-part (which should usually manage all the calculations) didn',
              "'",
              't exist yet, I couldn',
              "'",
              't just sent them to our server using AJAX. What now?'
            ),
            c.default.createElement(
              d.default,
              null,
              ...
              'Oh no! But we don',
              "'",
              't want to loose the ratings people will create while the server-side part of the voting system isn',
              "'",
              't fully implemented',
              '"',
              ', I thought. But then a brainstorm hit me: Why don',
              "'",
              't we simply save each rating locally, using cookies?'
            ),
            c.default.createElement(
              d.default,
              null,
            ...
            c.default.createElement(
              d.default,
              null,
              'Using this method, we were able to launch our product while still avoiding data loss: After I had finished the server-side part of the rating script, the only thing I needed to do was check the current visitors browser for cookies that are based on a movie',
              "'",
              's rating, save the amount of stars to the DB and set the',
              ' ',
              c.default.createElement(m.InlineCode, null, 'sync'),
              ' ',
              'key to',
              ' ',
              c.default.createElement(m.InlineCode, null, 'true'),
              ' ',
              '(so that it won',
              "'",
              't accidentally be saved again).'
            ),
            c.default.createElement(
              d.default,
              null,
            ...
            c.default.createElement(
              ...
              'Maybe this isn',
              "'",
              't a perfect approach. But what I hope is that this post can serve as inspiration for other developers (like you) to think of better solutions for this kind of situations. And in the end, me might all be able to keep a high standard for our products, while still complying with some deadlines.'
            ),
            c.default.createElement(
              d.default,
              null,
              'By the way, the source code of this project is available',
              ' ',
              c.default.createElement(
                u.default,
                { href: 'https://github.com/hakkens/hopper' },
                'on GitHub'
              ),
              ' ',
              'and commits are much welcome!'
            )
          )
        }
      },

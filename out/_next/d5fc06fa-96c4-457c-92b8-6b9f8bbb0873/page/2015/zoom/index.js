window.__NEXT_REGISTER_PAGE('/2015/zoom', function() {
          ...
          return function(e) {
            ...
            return g.default.createElement(
              ...
              g.default.createElement(
                M,
                u,
                S({ rows: X, stylesheet: a, useInlineStyles: p })
              )
            )
          }
        }
        ...
        l.exports = function(l) {
          ...
          return {
            ...
            contains: [
              ...
              l.COMMENT('\x3c!--', '--\x3e', { relevance: 10 }),
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, t, c) {
          ...
          try {
            ...
            return { relevance: T, value: B, language: l, top: M }
          } catch (l) {
        ...
        function f(l) {
          return (l = l.toLowerCase()), S[l] || S[x[l]]
        }
        var b = e(14)
        t.prototype = b
        var u = new t()
        ...
        !(function(l) {
          ...
          function j(l, e, r, c) {
            ...
            try {
              for (var S, C, M = 0; ; ) {
                if (
                  ((w.terminators.lastIndex = M), !(S = w.terminators.exec(e)))
                )
                  break
                ;(C = p(e.substring(M, S.index), S[0])), (M = S.index + C)
              }
      ...
      574: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            j.default,
            null,
            c.default.createElement(m.default, { id: 'zoom', hasCover: !0 }),
            ...
            c.default.createElement(
              f.default,
              null,
              'Just give your body the following property. It will make sure that the font size won’t get automatically adjusted by the system if the user changes to landscape mode. You can',
              ' ',
              c.default.createElement(
                u.default,
                {
              ...
              ' ',
              'about why it’s exactly needed and how you can achieve the same on a different mobile OS:'
            ),
            c.default.createElement(
              v.Code,
              { language: 'css', syntax: i.default },
            ...
            c.default.createElement(
              f.default,
              null,
              'Yeeeha! You made it! Your users are happy again, since they’re able to zoom in if they can’t read something. Great job!'
            ),
            c.default.createElement(
              f.default,
              null,
              ...
              c.default.createElement(
                u.default,
                { href: 'http://stackoverflow.com/a/27311443' },
                'answer'
              ),
              ' ',
              'caught my attention on Stack Overflow while I was searching for a solution to make it work on my own site.'
            )
          )
        }
      },

window.__NEXT_REGISTER_PAGE('/2013/attribut-selektoren-css', function() {
      ...
      14: function(l, o, e) {
        !(function(l) {
          ...
          function j(l, e, t, c) {
            ...
            function g() {
              ;(E += null != w.subLanguage ? u() : f()), (W = '')
            }
            function m(l) {
              ;(E += l.className ? b(l.className, '', !0) : ''),
            ...
            for (v = w; v !== y; v = v.parent)
              v.className && (E = b(v.className, '', !0) + E)
            var W = '',
              O = 0
            try {
              for (var S, C, M = 0; ; ) {
              ...
              for (p(e.substr(M)), v = w; v.parent; v = v.parent)
                v.className && (E += x)
              return { relevance: O, value: E, language: l, top: w }
            } catch (l) {
        ...
        o.default = function() {
          return c.default.createElement(
            ...
            c.default.createElement(
              b.default,
              null,
              'Hier finden sie die Beschreibung zu jedem einzelnen Attribut-Selektor, der im oberen Teil genannt worden ist. Jede Beschreibung bezieht sich jeweils auf alle ',
              '"',
              'E-Elemente',
              '"',
              '. Selbstverständlich kann dafür jeder Name verwendet werden.'
            ),
            c.default.createElement(
              u.UL,
              null,

window.__NEXT_REGISTER_PAGE('/2013/inhalte-zentrieren-css', function() {
    ...
    [27],
    {
        ...
        function a(l) {
          ...
          if (u) {
            var m = s(e, n),
              ...
              y = m(o.children)
            return b.default.createElement(u, (0, j.default)({ key: h }, p), y)
          }
        }
        Object.defineProperty(o, '__esModule', { value: !0 })
        var n = e(6),
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, r, c) {
          ...
          function h() {
            var l = void 0 === M.subLanguage ? f() : d()
            return (U = k), l
          }
          function d() {
            var l,
        ...
        function b(l) {
          return (l = l.toLowerCase()), S[l] || S[P[l]]
        }
        var f = e(14)
        r.prototype = f
        var u = new r()
        ...
        !(function(l) {
          ...
          function j(l, e, t, c) {
            ...
            function u() {
              ...
              return (
                ...
                b(e.language, e.value, !1, !0)
              )
            }
            function g() {
              ;(W += null != w.subLanguage ? u() : f()), (O = '')
            }
            function m(l) {
              ;(W += l.className ? b(l.className, '', !0) : ''),
            ...
            for (v = w; v !== y; v = v.parent)
              v.className && (W = b(v.className, '', !0) + W)
            var O = '',
              E = 0
            try {
              for (var S, x, M = 0; ; ) {
                if (
                  ...
                  break
                ;(x = p(e.substring(M, S.index), S[0])), (M = S.index + x)
              }
          ...
          function u(l) {
            ...
            t(h) ||
              ...
              (r.value = b(r.value)),
              (l.innerHTML = r.value),
              (l.className = f(l.className, h, r.language)),
          ...
          function k(l) {
            return (l = (l || '').toLowerCase()), A[l] || A[W[l]]
          }
          var w = [],
            _ = Object.keys,
            A = {},
        ...
        o.default = function() {
          return c.default.createElement(
            ...
            c.default.createElement(
              j.default,
              null,
              'Nun wird der Inhalt des als letztes genannten DIV-Element vertikal zentriert. Wenn nun auch noch eine horizontale Zentrierung gewünscht ist, kann diese natürlich ganz einfach mit dem ',
              c.default.createElement(
                f.InlineCode,
                null,
                'text-align: center;'
              ),
              '-Attribut für letzteres Element erreicht werden. Hierzu eine kleine ',
              c.default.createElement(
                g.default,
                { href: 'http://codepen.io/jonsuh/pen/duvgE' },
                'Demo'
              ),
              '.'
            ),
            c.default.createElement(
              j.default,
              null,
              'Falls die vertikale Zentrierung nicht innerhalb anderer Elemente erfolgt, müssen die Elemente ',
              c.default.createElement(f.InlineCode, null, 'html'),
              ' und',
              c.default.createElement(f.InlineCode, null, 'body'),
              ' in Sachen Breite und Höhe natürlich noch so angepasst werden, dass sie die Browser-Fläche komplett ausfüllen, wie in der Demo gezeigt. Viel Spaß beim Coden!'
            )
          )
        }
      },

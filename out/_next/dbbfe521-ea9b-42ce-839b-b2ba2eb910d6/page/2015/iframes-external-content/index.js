window.__NEXT_REGISTER_PAGE('/2015/iframes-external-content', function() {
    ...
    [8],
    {
      10: function(l, o, e) {
        ...
        o.default = function(l, o) {
          return function(e) {
            ...
            ;(O = !(!x || void 0 !== O) || O), (x = x || h)
            var R =
              t && l.getLanguage(t) ? l.highlight(t, B) : l.highlightAuto(B)
            ;(null !== R.language && 'text' !== t) ||
              (R.value = [{ type: 'text', value: B }])
            var L = a.hljs || { backgroundColor: '#fff' },
              I = p
                ? (0, d.default)({}, D, { style: (0, d.default)({}, L, j) })
      ...
      107: function(l, o, e) {
        ...
        ;(o.FootNotes = function(l) {
          ...
          (o.Ref = function(l) {
            ...
            return a.default.createElement(
              'a',
              { href: '#f' + o, id: 's' + o, className: 'jsx-940031118' },
              o,
              a.default.createElement(c.default, {
                styleId: '940031118',
                css: [
          ...
          (o.Note = function(l) {
            ...
            return a.default.createElement(
              ...
              a.default.createElement(
                'a',
                { href: '#s' + o, id: 'f' + o, className: 'jsx-2215405902' },
                o
              ),
              e,
              a.default.createElement(c.default, {
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, t, c) {
          function s(l, o) {
            var e, t, r
            if (((T += l), void 0 === o)) return u(h(), B), 0
            if ((e = S(o, M)))
              return u(h(), B), n(e, o), e.returnBegin ? 0 : o.length
            if ((t = E(M, o))) {
              ;(r = M), r.returnEnd || r.excludeEnd || (T += o), u(h(), B)
              do {
                M.className && P(), (U += M.relevance), (M = M.parent)
              } while (M !== t.parent)
              return (
                r.excludeEnd && g(o, B),
                (T = k),
          ...
          function u(l, o) {
            for (var e, t = l.length, r = -1; ++r < t; )
              (e = l[r]), e.type === O ? g(e.value, o) : o.push(e)
          }
          function g(l, o) {
            var e
            return (
              l &&
                ((e = o[o.length - 1]),
                e && e.type === O ? (e.value += l) : o.push(p(l))),
              o
            )
          }
          function p(l) {
          ...
          try {
            for (
              ...
              (R = s(o.substring(D, L.index), L[0])),
                (D = M.terminators.lastIndex = L.index + R),
                (L = M.terminators.exec(o))
            for (s(o.substr(D)), N = M; N.parent; )
              N.className && P(), (N = N.parent)
          ...
          function o(r, c) {
            ...
            r.compiled ||
              ...
              (a = r.contains
                ...
                .map(t)
                .filter(Boolean)),
              (r.terminators = a.length ? e(a.join(_), !0) : { exec: d }))
          }
          function e(o, e) {
        ...
        !(function(l) {
          ...
          function j(l, e, r, c) {
            ...
            function u() {
              ...
              var e = l
                ? j(w.subLanguage, W, !0, _[w.subLanguage])
                : d(W, w.subLanguage.length ? w.subLanguage : void 0)
              return (
            ...
            function g() {
              ;(O += null != w.subLanguage ? u() : b()), (W = '')
            }
            function m(l) {
              ;(O += l.className ? f(l.className, '', !0) : ''),
            ...
            for (v = w; v !== y; v = v.parent)
              v.className && (O = f(v.className, '', !0) + O)
            var W = '',
              E = 0
            try {
              for (var x, C, M = 0; ; ) {
              ...
              for (p(e.substr(M)), v = w; v.parent; v = v.parent)
                v.className && (O += S)
              return { relevance: E, value: O, language: l, top: w }
            } catch (l) {
          ...
          function k(l) {
            return (l = (l || '').toLowerCase()), A[l] || A[O[l]]
          }
          var w = [],
            _ = Object.keys,
            A = {},
        ...
        o.default = function() {
          return c.default.createElement(
            ...
            c.default.createElement(
              ...
              'If you',
              "'",
              're moving around the web once in a while, you certainly already know about them: iframes. They have been accompanying us since Netscape 2 and still haven',
              "'",
              't lost much of their popularity (although there are many other ways to load content of other websites into your site). Even big players like Twitter, Facebook or Google are using them to provide easy implementations of their data for developers.'
            ),
            c.default.createElement(
              j.default,
              null,
              'The reason behind that is, that iframes have been the best way to embed content that can',
              "'",
              't be modified by the existing styling of the site which it is getting loaded in. — But no longer!'
            ),
            c.default.createElement(g.H2, null, 'CSS3 to the Rescue...!'),
            c.default.createElement(
              j.default,
              null,
              'While digging through Mozilla',
              "'",
              's CSS docs, I was searching for a proper way to allow other developers to use a JS library',
              c.default.createElement(m.Ref, { id: '1' }),
              ' I was planning without needing to embed an iframe. It',
              "'",
              's the same problem that Twitter has with it',
              "'",
              's',
              ' ',
              c.default.createElement(
            ...
            c.default.createElement(
              j.default,
              null,
              'So after looking around a bit, I found',
              ' ',
              c.default.createElement(
                u.default,
                {
                  href: 'https://developer.mozilla.org/en-US/docs/Web/CSS/all'
                },
                'all'
              ),
              '. I literally cried tears of joy. The guys over at W3C finally managed to create a stable solution to reset all stylings for an element. And that',
              "'",
              's exactly what the property does, in a nutshell.'
            ),
            c.default.createElement(
              j.default,
              null,
            ...
            c.default.createElement(
              ...
              '... doesn',
              "'",
              't just change the heading',
              "'",
              's (let',
              "'",
              's say) font-size to 2em (which is the default one in HTML5). ',
              c.default.createElement('i', null, 'No!'),
              ' It set',
              "'",
              's the font size to 100%.'
            ),
            c.default.createElement(
              j.default,
              null,
              'Now you got it, right? Cool! Then let',
              "'",
              's talk about the possible cases in which we could use this property. One could be to solve the problem with iframes: They require your content to be completely put together in a HTML document on your server, before you can serve it. Then people are able to embed it into their site. But what if you don',
              "'",
              't want that?'
            ),
            c.default.createElement(
              j.default,
              null,
              'Instead of providing a fixed iframe for their embedded tweets, Twitter (as an example) could also supply developers with a JS script that pulls the tweet through their JSON API and then put it into a simple div (or maybe into an',
              ' ',
              c.default.createElement(p.InlineCode, null, 'blockquote'),
              ' ',
              'tag, if you want it to be semantic). There would only be one problem: Twitter couldn',
              "'",
              't provide a pre-defined styling for the embedded Tweet because it would be overridden.'
            ),
            c.default.createElement(
              j.default,
              null,
              'But they could! — If they start using the ',
              "'",
              'all',
              "'",
              '-property now!'
            ...
            c.default.createElement(g.H2, null, 'Other Use-Cases'),
            c.default.createElement(
              j.default,
              null,
              'As I already indicated, using the property as a faster alternative for iframes is not the only possible case where it can find application. Just think about how great it would be to be able to code a jQuery plugin which styles can',
              "'",
              't be overriden, for example.'
            ),
            c.default.createElement(
              j.default,
              null,
              'As many CSS properties I like to talk of, this one is very new',
              c.default.createElement(m.Ref, { id: '2' }),
              '. Nevertheless all major browsers (except Safari of course) are already able to interpret it. So let',
              "'",
              's go, start using it today!'
            ),
            c.default.createElement(
              m.FootNotes,
              null,
              c.default.createElement(
                ...
                'It',
                "'",
                's written in ES6 and will be published soon, so stay up-to-date! 😉'
              ),
              c.default.createElement(
                m.Note,
                { id: '2' },
                ...
                c.default.createElement(
                  u.default,
                  { href: 'http://caniuse.com/#search=all' },
                  'Can I Use'
                ),
                '.'
              )

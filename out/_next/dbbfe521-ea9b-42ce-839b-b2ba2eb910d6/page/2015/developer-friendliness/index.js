window.__NEXT_REGISTER_PAGE('/2015/developer-friendliness', function() {
        ...
        t.default = function() {
          return l.default.createElement(
            ...
            l.default.createElement(
              h.default,
              null,
              'But I can’t. „What the fuck does he want to tell me with this stupid shit?“ you might think. Well, let me make an example with JS: I’m thinking about developing a jQuery plugin. Now, the first thing you might be thinking is: „He shouldn’t use a framework like jQuery if he wants to create a maximum fast website“ (that’s exactly what I’m trying to accomplish). I was thinking the same thing. Okay, then let’s leave the framework out and create the ',
              l.default.createElement('i', null, 'e.g.'),
              ' slider in vanilla JS. So far so good, I made another move into the right direction.'
            ),
            l.default.createElement(
              h.default,
              null,
              'In spite of that I won’t create the slider library like this. Because now I’m thinking the following: If I put all my effort into this library, would it be really worth it if the developer also wants to add another library (e.g. for managing cookies or a simple light-box) to his project? ',
              l.default.createElement('b', null, 'No, it won’t be'),
              '. Why not? Well, just think about the possibility that one of those other libraries will contain a function thats exactly the same in my library. Summed up, this would mean that there will be multiple lines of duplicated code on his website. Thus, it will take a bit of time longer for the browser of the visitor to download the file (even if its just a few milliseconds - he can also add more libraries).'
            ),
            l.default.createElement(
              h.default,
              null,

window.__NEXT_REGISTER_PAGE('/2015/www-vs-no-www', function() {
    ...
    [11],
    {
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, t, c) {
          function s(l, o) {
            var e, t, r
            if (((U += l), void 0 === o)) return u(h(), B), 0
            if ((e = S(o, M)))
              return u(h(), B), n(e, o), e.returnBegin ? 0 : o.length
            if ((t = x(M, o))) {
              ;(r = M), r.returnEnd || r.excludeEnd || (U += o), u(h(), B)
              do {
          ...
          function n(l, o) {
            ...
            l.className && (e = v(l.className, [])),
              l.returnBegin
                ? (U = k)
                : l.excludeBegin ? (g(o, B), (U = k)) : (U = o),
              e && (B.push(e), I.push(B), (B = e.children)),
          ...
          try {
            ...
            return { relevance: F, value: B, language: l, top: M }
          } catch (l) {
        ...
        function f(l) {
          return (l = l.toLowerCase()), E[l] || E[S[l]]
        }
        var b = e(14)
        t.prototype = b
        var u = new t()
      ...
      569: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            i.default,
            null,
            c.default.createElement(f.default, { id: 'www-vs-no-www' }),
            ...
            c.default.createElement(
              ...
              ' - Well, to be honest, I wont be able to provide you with a solution that’s the right in any case. BUTT I can show you how to decide, which way is the best for your kind of project...'
            ),
            c.default.createElement(m.H2, null, 'Who Should Use WWW'),
            c.default.createElement(
              j.default,
              null,
              'Many system administrators will advise you to not support the deprecation of the ',
              '"',
              'www',
              '"',
              ' prefix. The reason behind that is, that it will allow your host to forward visitors to another server if the current one is on fire. To do that, they need to be able to update the DNS records of your domain (which is done using CNAME entries). Unfortunately, using this procedure is not possible without the ',
              c.default.createElement('i', null, 'www'),
              '.'
            ),
            c.default.createElement(
              j.default,
              ...
              'But don',
              "'",
              't worry, if your site doesn',
              "''",
              't get tons of traffic each day, this isn',
              "'",
              't something you need to worry about. Mostly people who are using cloud application providers like',
              ' ',
              c.default.createElement(
                u.default,
            ...
            c.default.createElement(
              j.default,
              null,
              'Another tiny weak spot on the big balloon that represents all developers fighting for the abolition of ',
              c.default.createElement('i', null, 'www'),
              ' is definitely, that it if you set up a cookie for a domain like ',
              '"',
              'www.mysite.org',
              '"',
              ', the browser won',
              "'",
              't sent it out when accessing content on subdomains like',
              ' ',
              '"',
              'dumb.mysite.org',
              '"',
              ...
              c.default.createElement('i', null, 'www'),
              ' ',
              'on your main domain, the cookie will be shared on all connections to all subdomains.'
            ),
            c.default.createElement(m.H2, null, "Who Shouldn't Use WWW"),
            c.default.createElement(
              j.default,
              null,
            ...
            c.default.createElement(
              ...
              'If we',
              "'",
              're currently talking about a really huge business - I mean, really huge (like McDonalds) - who is putting it',
              "'",
              's address on every fucking print, this might also save a large amount of ink and therefore also ink',
              c.default.createElement(v.Ref, { id: '1' }),
              ' - you',
              "'",
            ...
            c.default.createElement(
              ...
              ' ',
              c.default.createElement(g.InlineCode, null, '.htaccess'),
              ' ',
              'file with the following contents to the root directory of your site:'
            ),
            c.default.createElement(
              g.Code,
              { language: 'apache', syntax: a.default },
            ...
            c.default.createElement(
              ...
              'Okay, we',
              "'",
              're finished! Now take a look at your project and make the best possible descision.'
            ),
            c.default.createElement(
              j.default,
              null,
              'All in all I nevertheless think that YOU (if you don’t have a site that gets hundreds of thousands of visitors each day) should start deprecating the subdomain ',
              c.default.createElement('b', null, 'today'),
              ', so that the webhosters will respond to this issue with a better solution in the future.'
            ),
            c.default.createElement(
              v.FootNotes,
              null,
      ...
      570: function(l, o) {
        l.exports = function(l) {
          var o = { className: 'number', begin: '[\\$%]\\d+' }
          return {
            aliases: ['apacheconf'],
            case_insensitive: !0,
            contains: [

window.__NEXT_REGISTER_PAGE('/2013/ios-apps-ansprechen', function() {
    ...
    [24],
    {
          ...
          return function(e) {
            ...
            return g.default.createElement(
              ...
              g.default.createElement(
                M,
                u,
                S({ rows: I, stylesheet: a, useInlineStyles: p })
              )
            )
          }
        }
        ...
        function a(l, o, e, r, c) {
          ...
          function u(l, o) {
            for (var e, r = l.length, t = -1; ++t < r; )
              (e = l[t]), e.type === O ? g(e.value, o) : o.push(e)
          }
          function g(l, o) {
            var e
            return (
      ...
      14: function(l, o, e) {
        !(function(l) {
            ...
            function b() {
              ...
              for (
                t = '',
                  ...
                  r = w.lexemesRe.exec(W);
                r;

              )
                (t += o(W.substring(e, r.index))),
                  (l = i(w, r)),
                  l ? ((E += l[1]), (t += f(l[0], o(r[0])))) : (t += o(r[0])),
                  (e = w.lexemesRe.lastIndex),
                  (r = w.lexemesRe.exec(W))
              return t + o(W.substr(e))
            }
            function u() {
              var l = 'string' == typeof w.subLanguage
              if (l && !_[w.subLanguage]) return o(W)
              var e = l
                ? j(w.subLanguage, W, !0, A[w.subLanguage])
          ...
          function k(l) {
            return (l = (l || '').toLowerCase()), _[l] || _[O[l]]
          }
          var w = [],
            A = Object.keys,
            _ = {},
      ...
      479: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            i.default,
            null,
            c.default.createElement(f.default, { id: 'ios-apps-ansprechen' }),
            ...
            c.default.createElement(
              j.default,
              null,
              'Also habe ich mich auf die Suche gemacht und bin auf eine ',
              c.default.createElement(
                g.default,
                { href: 'http://apple.co/2ks9JBI' },
                'Website'
              ),
              ' gestoßen, die URL-Schemes einiger bekannter iOS-Apps kostenfrei auflistet. Dort habe ich mir dann z.B. das ensprechende URL-Schema zum Ansprechen der offiziellen Twitter-App gegriffen.'
            ),
            c.default.createElement(
              j.default,
              null,
            ...
            c.default.createElement(
              j.default,
              null,
              'Das ganze packen wir dann am besten noch in eine eigene Funktion, welche wir mit Hilfe des',
              ' ',
              '"',
              'OnClick',
              '"',
              '-Eventhandlers z.B. durch einen HTML-Link ansprechen. Nun versucht der Browser die iOS-App zu öffnen - wenn diese nicht erreicht werden kann, wird der Link des Webclients gecallt.'
            ),
            c.default.createElement(
              j.default,
              null,

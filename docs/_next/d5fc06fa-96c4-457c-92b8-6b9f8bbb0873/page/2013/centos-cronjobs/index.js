window.__NEXT_REGISTER_PAGE('/2013/centos-cronjobs', function() {
      ...
      461: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            i.default,
            null,
            c.default.createElement(b.default, { id: 'centos-cronjobs' }),
            ...
            c.default.createElement(
              j.default,
              null,
              'Nun starte ich die Erstellung einer neuen Cron-Aufgabe mittels ',
              c.default.createElement(u.InlineCode, null, 'crontab -e'),
              '. Dies wird den Editor öffnen, in den ich dann den Syntax für den gewünschten Cron-Task eingebe. Dieser wird mit Hilfe des folgenden Schemas aufgebaut:'
            ),
            c.default.createElement(d.Image, {
              src: '/static/essays/2013/cronjob-aufbau.png'
            }),
            c.default.createElement(
              j.default,
              null,
            ...
            c.default.createElement(
              j.default,
              null,
              'Nun fügen die gewünschte Sache ein, die ausgeführt werden soll. Dies kann ein Programm, ein Kommando, aber auch - wie in meinem Fall - ein ausführbares Script sein. Jetzt muss ich die Datei finden, welche es ermöglicht, mein Script zu analysieren und auszuführen. Der Dateipfad für die Executable ist:',
              ' ',
              c.default.createElement(u.InlineCode, null, '/usr/bin/php'),
              '.'
            ),
            c.default.createElement(
              j.default,
              null,
              'Dahinter fügen wir den Pfad zur PHP-Datei ein, welche ausgeführt werden soll. In meinem Fall lautet dieser wie folgt: ',
              c.default.createElement(
                u.InlineCode,
                null,
                '/var/www/html/backup.php'
              ),
              '. Somit sieht das Kommando, welches wir im Editor einfügen, genau so aus:'
            ),
            c.default.createElement(
              u.Code,
              { language: 'bash', syntax: a.default },

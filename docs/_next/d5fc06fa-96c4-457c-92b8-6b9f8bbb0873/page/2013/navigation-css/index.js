window.__NEXT_REGISTER_PAGE('/2013/navigation-css', function() {
    ...
    [20],
    {
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, r, c) {
          function s(l, o) {
            var e, r, t
            if (((I += l), void 0 === o)) return u(h(), D), 0
            if ((e = x(o, M)))
              return u(h(), D), n(e, o), e.returnBegin ? 0 : o.length
            if ((r = E(M, o))) {
              ;(t = M), t.returnEnd || t.excludeEnd || (I += o), u(h(), D)
              do {
          ...
          function n(l, o) {
            ...
            l.className && (e = v(l.className, [])),
              l.returnBegin
                ? (I = k)
                : l.excludeBegin ? (g(o, D), (I = k)) : (I = o),
              e && (D.push(e), U.push(D), (D = e.children)),
          ...
          function d() {
            ...
            return o && !S[M.subLanguage]
              ? g(I, [])
              : ((l = o
                  ? a(M.subLanguage, I, !0, r, X[M.subLanguage])
                  : t(I, {
          ...
          function f() {
            var l,
              ...
              r,
              t = []
            if (!M.keywords) return g(I, t)
            for (l = 0, M.lexemesRe.lastIndex = 0, o = M.lexemesRe.exec(I); o; )
              g(I.substring(l, o.index), t),
                (r = w(M, o)),
                r
                  ? ((T += r[1]),
                    (e = v(r[0], [])),
                ...
                (o = M.lexemesRe.exec(I))
            return g(I.substr(l), t), t
          }
          function u(l, o) {
          ...
          try {
            ...
            return { relevance: T, value: D, language: l, top: M }
          } catch (l) {
      ...
      485: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            j.default,
            null,
            c.default.createElement(g.default, { id: 'navigation-css' }),
            ...
            c.default.createElement(
              b.default,
              null,
              'Und schon ist die Navigation fertig. Absolut ohne Javascript, sondern aus reinem CSS und HTML. Nach Wunsch können für ',
              c.default.createElement(f.InlineCode, null, 'display'),
              ' auch andere Attribute wie',
              ' ',
              c.default.createElement(f.InlineCode, null, 'height'),
              ' ',
              'oder',
              ' ',
              c.default.createElement(f.InlineCode, null, 'visibility'),
              ' ',
              'verwendet werden. Auch CSS3-Transitions sind erlaubt.'
            )
          )
        }
      },

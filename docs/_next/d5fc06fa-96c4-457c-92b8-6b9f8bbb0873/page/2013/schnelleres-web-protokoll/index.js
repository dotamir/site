window.__NEXT_REGISTER_PAGE('/2013/schnelleres-web-protokoll', function() {
  var comp = (module.exports = webpackJsonp(
    [30],
    {
        ...
        o.default = function(l, o) {
          return function(e) {
            var r = e.language,
              ...
              M = void 0 === C ? 'code' : C,
              D = e.code,
              B = void 0 === D ? (Array.isArray(t) ? t[0] : t) : D,
              N = (0, b.default)(e, [
                'language',
                'children',
                'style',
            ...
            var L = a.hljs || { backgroundColor: '#fff' },
              q = p
                ? (0, d.default)({}, N, { style: (0, d.default)({}, L, j) })
            ...
            return g.default.createElement(
              ...
              g.default.createElement(
                M,
                u,
                P({ rows: X, stylesheet: a, useInlineStyles: p })
              )
            )
          }
        }
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, r, c) {
          function s(l, o) {
            ...
            if ((r = S(M, o))) {
              ...
              do {
                M.className && x(), (T += M.relevance), (M = M.parent)
              } while (M !== r.parent)
              return (
                t.excludeEnd && g(o, B),
                (U = k),
          ...
          if (((C = f(l)), (D = M = c || C), (B = q = []), !C))
            throw new Error('Unknown language: `' + l + '` is not registered')
          i(C)
          try {
            for (
              N = M.terminators.lastIndex = 0, L = M.terminators.exec(o);
              L;

            )
              (R = s(o.substring(N, L.index), L[0])),
                (N = M.terminators.lastIndex = L.index + R),
                (L = M.terminators.exec(o))
            for (s(o.substr(N)), D = M; D.parent; )
              D.className && x(), (D = D.parent)
        ...
        function f(l) {
          return (l = l.toLowerCase()), P[l] || P[E[l]]
        }
        var b = e(14)
        r.prototype = b
        var u = new r()
        ...
        !(function(l) {
          ...
          function j(l, e, t, c) {
            ...
            try {
              for (var P, C, M = 0; ; ) {
                if (
                  ((w.terminators.lastIndex = M), !(P = w.terminators.exec(e)))
                )
                  break
                ;(C = p(e.substring(M, P.index), P[0])), (M = P.index + C)
              }
        ...
        o.default = function() {
          return c.default.createElement(
            ...
            c.default.createElement(
              i.default,
              null,
              'Dann hatte er mir von einer Software für Apache 2.2 erzählt, die es ermöglicht, aus SPDY-Funktionen wie',
              ' ',
              '"',
              'stream',
              '"',
              ...
              '"',
              ' ',
              'einen Vorteil zu ziehen. Somit sah ich mir die Erweiterung mal an.'
            ),
            c.default.createElement(
              i.default,
              null,
              'Zunächst einmal möchte ich überhaupt das Wirken der Software genauer erläutern: In Zusammenarbeit mit dem Programm kann Apache mit Browsern, die das Protokoll ',
              '"',
              'SPDY',
              '"',
              ' beherrschen, Daten auf diesem Weg austauschen. Die HTTP-Alternative ',
              '"',
              'SPDY',
              '"',
              ' soll die Ladezeit von Webseiten um rund 55 Prozent reduzieren. SPDY wird derzeit von Google Chrome und Firefox unterstützt.'
            ),
            c.default.createElement(
              i.default,
              null,
              'Klingt eigentlich ganz gut, nicht war? Schade ist nur, dass ',
              c.default.createElement(d.InlineCode, null, 'mod_spdy'),
              ' bei jeder Verbindung zwischen Endbenutzer und Server das HTTPS-Protokoll erzwingt. Wer das Modul trotzdem ausprobieren möchte, kann sich dieses für CentOS sowie für Debian',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'https://developers.google.com/speed/spdy/mod_spdy/' },
                'hier'
              ),
              ' ',
              'herunterladen. Ich werde es demnächst auch einmal genauer prüfen.'
            ),
            c.default.createElement(
              i.default,
              null,
              'Einer der entscheidenden Faktoren für die Steigerung der Geschwindigkeit durch SPDY ist das sogenannte ',
              '"',
              'Multiplexing',
              '"',
              ': SPDY erlaubt es, mehrere HTTP-Requests in einer ',
              c.default.createElement('b', null, 'einzigen'),
              ' TCP-Session abzuwickeln. Dies reduziert die Bandbreite gegenüber dem heute genutzten HTTP durch Eliminierung von überflüssigen Headern und Komprimierung. Weniger Verbindungen müssen aufgebaut werden.'
            ),
            c.default.createElement(
              i.default,
              null,
            ...
            c.default.createElement(
              i.default,
              null,
              'Ein kleines Video, in dem das Programm im Zusammenhang mit einer normalen HTML-Seite mit einigen Grafiken genutzt wird, ist übrigends ',
              c.default.createElement(
                b.default,
                { href: 'https://youtu.be/vEYKRhETy4A' },
                'hier'
              ),
              ' zu finden.'
            )

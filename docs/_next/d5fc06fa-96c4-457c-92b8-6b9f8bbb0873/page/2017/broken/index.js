        ...
        l.exports = function(l) {
          var o = { literal: 'true false null' },
            ...
            c = {
              ...
              contains: [l.inherit(r)],
              illegal: '\\S'
            }
          return (
            e.splice(e.length, 0, t, c),
        ...
        function a(l, o, e, r, c) {
          ...
          function u(l, o) {
            for (var e, r = l.length, t = -1; ++t < r; )
              (e = l[t]), e.type === x ? g(e.value, o) : o.push(e)
          }
          function g(l, o) {
            var e
            return (
              l &&
                ((e = o[o.length - 1]),
                e && e.type === x ? (e.value += l) : o.push(p(l))),
              o
            )
          }
          function p(l) {
            return { type: x, value: l }
          }
          function v(l, o, e) {
            return {
              type: A,
          ...
          function O(l, o) {
            ...
            if (l.endsWithParent) return O(l.parent, o)
          }
          function S(l, o) {
        ...
        !(function(l) {
          ...
          function j(l, e, t, c) {
            ...
            function u() {
              ...
              return (
                w.relevance > 0 && (O += e.relevance),
                l && (_[w.subLanguage] = e.top),
                f(e.language, e.value, !1, !0)
              )
            }
            function g() {
              ;(x += null != w.subLanguage ? u() : b()), (W = '')
            }
            function m(l) {
              ;(x += l.className ? f(l.className, '', !0) : ''),
            ...
            for (v = w; v !== y; v = v.parent)
              v.className && (x = f(v.className, '', !0) + x)
            var W = '',
              O = 0
            try {
              for (var E, C, M = 0; ; ) {
              ...
              for (p(e.substr(M)), v = w; v.parent; v = v.parent)
                v.className && (x += S)
              return { relevance: O, value: x, language: l, top: w }
            } catch (l) {
          ...
          function k(l) {
            return (l = (l || '').toLowerCase()), A[l] || A[x[l]]
          }
          var w = [],
            _ = Object.keys,
            A = {},

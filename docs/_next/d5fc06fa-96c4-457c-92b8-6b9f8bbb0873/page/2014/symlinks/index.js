window.__NEXT_REGISTER_PAGE('/2014/symlinks', function() {
    ...
    [13],
    {
        ...
        o.default = function(l, o) {
          return function(e) {
            var r = e.language,
              ...
              M = void 0 === C ? 'code' : C,
              N = e.code,
              D = void 0 === N ? (Array.isArray(t) ? t[0] : t) : N,
              B = (0, b.default)(e, [
                'language',
                'children',
                'style',
            ...
            var R = a.hljs || { backgroundColor: '#fff' },
              q = p
                ? (0, d.default)({}, B, { style: (0, d.default)({}, R, j) })
                : (0, d.default)({}, B, { className: 'hljs' }),
              X = W ? i(L, x) : L.value,
              I = v
          ...
          h = function(l) {
            ...
            return (
              ...
              a.default.createElement(
                'li',
                { className: 'jsx-3704132522 ' + (r.join(' ') || '') },
                o,
                a.default.createElement(c.default, {
                  styleId: '3704132522',
                  css: [
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, r, c) {
          ...
          if (((C = f(l)), (N = M = c || C), (D = q = []), !C))
            throw new Error('Unknown language: `' + l + '` is not registered')
          i(C)
          try {
            for (
              B = M.terminators.lastIndex = 0, R = M.terminators.exec(o);
              R;

            )
              (L = s(o.substring(B, R.index), R[0])),
                (B = M.terminators.lastIndex = R.index + L),
                (R = M.terminators.exec(o))
            for (s(o.substr(B)), N = M; N.parent; )
      ...
      509: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            a.default,
            null,
            c.default.createElement(f.default, { id: 'symlinks' }),
            c.default.createElement(
              ...
              'Arbeitsplatz',
              '"',
              ' ja gerne immer relativ ordentlich habe, musste es natürlich irgendwann so weit kommen, dass mir diese dummen Dinger einfach ins Auge stechen. Wie es der Titel schon unschwer vermuten lässt, zeige ich dir heute, wie du diese kleinen Pfeile von den Verknüpfungen auf deinem Win7-Desktop entfernen kannst.'
            ),
            c.default.createElement(
              i.default,
              null,
              'Gleich zu Anfang: Falls du schlicht keine Lust auf die unten stehende Anleitung hast, kannst du dir auch gerne ein',
              ' ',
              c.default.createElement(
                j.default,
                {
                  href:
                    'http://www.delightsoftware.com/de/ShortcutOverlayRemover'
                },
                'Programm'
              ),
              ' ',
              'laden, welches die Arbeit dann für dich erledigt.'
            ),
            c.default.createElement(
              i.default,
              null,
            ...
            c.default.createElement(
              ...
              c.default.createElement(
                u.LI,
                null,
                'Öffne die Explorer-Suche und finde ',
                '"',
                'regedit',
                '"',
                ' (.exe)'
              ...
              c.default.createElement(
                u.LI,
                null,
                'Nachdem du die Datei geöffnet hast, navigiere zu folgendem Verzeichnis:',
                ' ',
                c.default.createElement(
                  g.InlineCode,
                  null,
                ...
                '. Dort sollte sich eine Verzeichnis mit dem Namen ',
                '"',
                'Shell Icons',
                '"',
                ' befinden. (Falls selbiges ',
                c.default.createElement('b', null, 'nicht'),
                ' vorhanden ist, erstelle es wie folgt: Rechtsklick auf das ',
                '"',
                'Explorer',
                '"',
                '-Verzeichnis, dann ',
                ...
                'Schlüssel',
                '"',
                ' wählen. Der entstandene Ordner muss dann ',
                '"',
                'Shell Icons',
                '"',
                ' genannt werden.)'
              ...
              c.default.createElement(
                ...
                'Shell Icons',
                '"',
                '-Verzeichnis die nötigen Bedingungen setzen, um den blöden Pfeil verschwinden zu lassen: Klicke einfach mit einem Rechtsklick auf den ',
                '"',
                'Shell Icons',
                '"',
                '-Ordner und wähle dann unter ',
                '"',
                'Neu',
                '"',
                ' den Punkt ',
                ...
                'Zeichenfolge',
                '"',
                '. Als Titel für die neue Zeichenfolgen gibst du die Zahl ',
                c.default.createElement(g.InlineCode, null, '29'),
                ' ein.'
              ),
              c.default.createElement(
                u.LI,
                null,
                'Als nächstes klickst du doppelt auf die angelegte Zahl 29. Jetzt sollte sich ein Fenster öffnen, in welchem du den Pfad zum neuen Verknüpfungs-Pfeil eingeben kannst. Um den Pfeil ganz verschwinden zu lassen, gibst du z.B. folgenden Pfad an (enthält ein leeres Icon):',
                ' ',
                c.default.createElement(
                  g.InlineCode,
                  null,
                  'C:Windowssystem32imageres.dll,-121'
                )
              ),
              c.default.createElement(
                u.LI,
                null,
                c.default.createElement('b', null, 'Achtung:'),
                ' (Falls im ',
                '"',
                'Shell Icons',
                '"',
                '-Ordner bereits eine Zeichenfolge mit dem Titel ',
                '"',
                '(Standard)',
                '"',
                ' vorhanden ist, ignoriere diesen Schritt bitte!) - Lege mit dem selben Schema wie in Punkt 3 einen weitere Zeichenfolge an, allerdings mit dem Namen ',
                '"',
                '(Standart)',
                '"',
                ' (Wer kann leer gelassen werden).'
              ),
              c.default.createElement(
                u.LI,
                null,
                'Hast du den Pfad angegeben, kannst du ihn mit einem Klick auf ',
                '"',
                'OK',
                '"',
                ' abspeichern. Nun musst du dein System nur noch einmal neu starten, und schwups: Der nervige Pfeil ist weg! :)'
              )
            ),
            c.default.createElement(b.H2, null, 'Aktion rückgängig machen'),
            c.default.createElement(
              i.default,
              null,
              'Du möchtest dein Verknüpfungs-Pfeil wiederherstellen? Kein Problem! Lösche einfach den Ordner ',
              '"',
              'Shell Icons',
              '"',
              ', welchen du nach der obigen Anleitung erstellt hast, und starte deinen PC nochmals neu. Schon ist er wieder da!'
            ),
            c.default.createElement(
              i.default,
              null,

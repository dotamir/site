window.__NEXT_REGISTER_PAGE('/2016/ember-route', function() {
        ...
        o.default = function(l, o) {
          return function(e) {
            var r = e.language,
              ...
              M = void 0 === P ? 'code' : P,
              N = e.code,
              B = void 0 === N ? (Array.isArray(t) ? t[0] : t) : N,
              D = (0, b.default)(e, [
                'language',
                'children',
                'style',
            ...
            var R =
              r && l.getLanguage(r) ? l.highlight(r, B) : l.highlightAuto(B)
            ;(null !== R.language && 'text' !== r) ||
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, r, c) {
          function s(l, o) {
            ...
            if ((r = W(M, o))) {
              ;(t = M), t.returnEnd || t.excludeEnd || (U += o), u(h(), B)
              do {
                M.className && C(), (T += M.relevance), (M = M.parent)
              } while (M !== r.parent)
              return (
                t.excludeEnd && g(o, B),
                (U = k),
          ...
          function d() {
            ...
            return o && !S[M.subLanguage]
              ? g(U, [])
              : ((l = o
                  ? a(M.subLanguage, U, !0, r, q[M.subLanguage])
                  : t(U, {
          ...
          function u(l, o) {
            for (var e, r = l.length, t = -1; ++t < r; )
              (e = l[t]), e.type === E ? g(e.value, o) : o.push(e)
          }
          function g(l, o) {
            var e
            return (
          ...
          function o(t, c) {
            function s(o, e) {
              ...
              for (
                ...
                (t = r[c].split(_)), (i[t[0]] = [o, t[1] ? Number(t[1]) : 1])
            }
            var a,
              i = {}
            t.compiled ||
              ...
              c &&
                (t.beginKeywords &&
                  (t.begin =
                    '\\b(' + t.beginKeywords.split(w).join(_) + ')\\b'),
                t.begin || (t.begin = /\B|\b/),
                (t.beginRe = e(t.begin)),
                ...
                t.endsWithParent &&
                  c.terminatorEnd &&
                  (t.terminatorEnd += (t.end ? _ : k) + c.terminatorEnd)),
              ...
              (a = t.contains
                ...
                .map(r)
                .filter(Boolean)),
              (t.terminators = a.length ? e(a.join(_), !0) : { exec: d }))
          }
          function e(o, e) {
        ...
        !(function(l) {
              ...
              if (!t.compiled) {
                if (
                  ...
                  'string' == typeof t.keywords
                    ...
                    : _(t.keywords).forEach(function(l) {
                        a(l, t.keywords[l])
                      }),
                    (t.keywords = s)
                }
          ...
          function j(l, e, t, c) {
            ...
            function u() {
              ...
              if (l && !A[w.subLanguage]) return o(O)
              var e = l
                ? j(w.subLanguage, O, !0, _[w.subLanguage])
            ...
            try {
              for (var S, P, M = 0; ; ) {
                if (
                  ...
                  break
                ;(P = p(e.substring(M, S.index), S[0])), (M = S.index + P)
              }
      ...
      578: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            i.default,
            null,
            c.default.createElement(u.default, { id: 'ember-route' }),
            c.default.createElement(
              j.default,
              null,
              'When I first came in touch with Ember.js to build the client-side rendered version of',
              ' ',
              c.default.createElement(
                f.default,
              ...
              ', I was looking for a way to add the name of the currently active route to the body. I needed it because I wanted certain styles to only be applied to the elements within a certain route.'
            ),
            c.default.createElement(
              j.default,
              null,
              'So after looking around the web for a few minutes, I’ve found',
              ' ',
              c.default.createElement(
                f.default,
                { href: 'https://github.com/AddJam/ember-body-class' },
                'ember-body-class'
              ),
              ' ',
              '— an add-on which does exactly that. If you just want to take advantage of the body classes that are based on the route name, you don’t even need to configure a single thing!'
            ),
            c.default.createElement(
              j.default,
              null,
            ...
            c.default.createElement(
              j.default,
              null,
              'So after looking for ways to solve this problem within an additional add-on, I came across',
              ' ',
              c.default.createElement(
                f.default,
                {
              ...
              '. It picks the name of the current route (“users.edit” for example), replaces all dots with dashes and finally adds it to the body’s “class” attribute.'
            ),
            c.default.createElement(
              j.default,
              null,
            ...
            c.default.createElement(j.default, null, 'So there you have it!'),
            c.default.createElement(
              j.default,
              null,

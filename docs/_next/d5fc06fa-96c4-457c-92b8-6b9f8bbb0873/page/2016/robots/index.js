window.__NEXT_REGISTER_PAGE('/2016/robots', function() {
    ...
    [10],
    {
        ...
        o.default = function(l, o) {
          return function(e) {
            var t = e.language,
              ...
              M = void 0 === P ? 'code' : P,
              N = e.code,
              B = void 0 === N ? (Array.isArray(r) ? r[0] : r) : N,
              D = (0, u.default)(e, [
                'language',
                'children',
                'style',
            ...
            return g.default.createElement(
              ...
              g.default.createElement(
                M,
                b,
                W({ rows: q, stylesheet: a, useInlineStyles: p })
              )
            )
          }
        }
          ...
          return {
            ...
            contains: [
              ...
              },
              {
                ...
                excludeEnd: !0,
                contains: [
                  l.inherit(l.TITLE_MODE, { begin: o }),
                  {
                    className: 'params',
                    begin: /\(/,
                    end: /\)/,
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, t, c) {
          function s(l, o) {
            var e, t, r
            if (((T += l), void 0 === o)) return b(h(), B), 0
            if ((e = S(o, M)))
              return b(h(), B), n(e, o), e.returnBegin ? 0 : o.length
            if ((t = x(M, o))) {
              ;(r = M), r.returnEnd || r.excludeEnd || (T += o), b(h(), B)
              do {
          ...
          function n(l, o) {
            ...
            l.className && (e = v(l.className, [])),
              l.returnBegin
                ? (T = k)
                : l.excludeBegin ? (g(o, B), (T = k)) : (T = o),
              e && (B.push(e), X.push(B), (B = e.children)),
          ...
          if (((P = f(l)), (N = M = c || P), (B = R = []), !P))
            throw new Error('Unknown language: `' + l + '` is not registered')
          i(P)
          try {
            for (
              D = M.terminators.lastIndex = 0, L = M.terminators.exec(o);
              L;

            )
              (I = s(o.substring(D, L.index), L[0])),
                (D = M.terminators.lastIndex = L.index + I),
                (L = M.terminators.exec(o))
            for (s(o.substr(D)), N = M; N.parent; )
              N.className && C(), (N = N.parent)
            return { relevance: U, value: B, language: l, top: M }
          } catch (l) {
        ...
        !(function(l) {
          ...
          function d(l, e, r, c) {
            ...
            try {
              for (var W, P, M = 0; ; ) {
                if (
                  ((w.terminators.lastIndex = M), !(W = w.terminators.exec(e)))
                )
                  break
                ;(P = p(e.substring(M, W.index), W[0])), (M = W.index + P)
              }
      ...
      598: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            d.default,
            null,
            c.default.createElement(m.default, { id: 'robots', hasCover: !0 }),
            c.default.createElement(
              ...
              ' ',
              'at the end of last year, all of my expectations have been exceeded completely. One thing that especially blew my mind was how much they were talking about hardware, rather than just how to build better websites with JS.'
            ),
            c.default.createElement(
              f.default,
              null,
              'As an example, Pawel Szymczykowski was giving',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'https://www.youtube.com/watch?v=xzBloghQhO4' },
                'a talk'
              ),
              ' ',
              'about how to build a balloon carrying a payload of sensors and cameras driven by JavaScript that flies twice the height of a commercial airline. After that (or before, I honestly don’t remember the order), Thomas Watson showed us',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'https://www.youtube.com/watch?v=c5GlZp6L9P4' },
                'a way'
              ),
              ' ',
              'to hack Apple’s AirPlay protocol and easily setup a server to which we can stream music. And many more!'
            ),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(y.H2, null, 'Requirements'),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(
              f.default,
              null,
              'There are several different kinds of programmable micro-controllers out there on the market. But for now, we just need one: Because I had a very good experience with it so far, I suggest going with ',
              c.default.createElement(
                b.default,
                { href: 'https://www.arduino.cc' },
                'Arduino'
              ),
              ' (outside of the US, it’s called “Genuino” because of a',
              ' ',
              c.default.createElement(
                b.default,
                {
                  href:
                    'http://www.open-electronics.org/from-arduino-to-genuino-the-reasons-for-a-choice/'
                },
                'trademark issue'
              ),
              '). Besides of that, it’s also the recommended board of the library we’re going to use to control it using Node.'
            ),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(
              ...
              c.default.createElement(
                v.LI,
                null,
                'However, I generally recommend buying the',
                ' ',
                c.default.createElement('b', null, 'Starter Kit'),
                ' ',
                '(',
                c.default.createElement(
                  b.default,
                ...
                c.default.createElement(
                  b.default,
                  { href: 'https://store.arduino.cc/product/GKX00007' },
                  'other countries'
                ),
                ') because it contains a huge varity of other components as well. This makes it easier for you to continue building various things after making it through this article.'
              ),
              c.default.createElement(
                v.LI,
                null,
                'If you’d like to protect your USB ports from getting overloaded, I also suggest buying a ',
                c.default.createElement(
                  'b',
                  null,
                ...
                c.default.createElement(
                  b.default,
                  { href: 'http://amzn.to/2iBXkdX' },
                  'this one'
                ),
                '). But if you’re using a high-quality device like a MacBook, this shouldn’t be necessary because the system will automatically shut down the port if something unexpected happens.'
              ),
              c.default.createElement(
                v.LI,
                null,
                'And if you’re really into making sure that it gets done properly, you can also order',
                ' ',
                c.default.createElement('b', null, 'a case'),
                ' ',
                '(',
                c.default.createElement(
                  b.default,
                  { href: 'http://amzn.to/2jokB0k' },
                  'this one'
                ),
                ' ',
                'is mine) which protects the main board from getting damaged. In this case, you’ll also have to get a cross-tip screwdriver, if you don’t have one.'
              )
            ),
            c.default.createElement(
              f.default,
              null,
              'In the next section of this tutorial, I’m just going to assume that you’ve bought everything mentioned above. If something hasn’t arrived yet, make sure to',
              ' ',
              c.default.createElement(
                b.default,
                {
                  href:
                    'https://help.medium.com/hc/en-us/articles/214993247-Bookmarks'
                },
                'bookmark'
              ),
              ' ',
              'this article and revisit it later.'
            ),
            c.default.createElement(p.Image, {
              src: '/static/essays/2016/robots/package.png'
            }),
            c.default.createElement(y.H2, null, 'Setup'),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(
              f.default,
              null,
              'Because of this, we need to make sure that the board is able to accept tasks over this protocol as the next step. To do that, we’re going to',
              ' ',
              c.default.createElement(
                b.default,
              ...
              ' ',
              'the Arduino app (the IDE I’ve mentioned before), open it and select the default version of the protocol in the menu bar:'
            ),
            c.default.createElement(p.Image, {
              src: '/static/essays/2016/robots/protocol.png'
            }),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(p.Image, {
              src: '/static/essays/2016/robots/tools-board.png'
            }),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(p.Image, {
              src: '/static/essays/2016/robots/tools-port.png'
            }),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(
              f.default,
              null,
              'The board should now show a green light which says “ON” next to it. If that’s not the case, please try re-connecting it to your machine and hit the red “RESET” button on the board. If that still doesn’t change make the green LED light up, consider',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'https://gitter.im/rwaldron/johnny-five' },
                'asking the community for help'
              ),
              '.'
            ),
            c.default.createElement(y.H2, null, 'Telling the Board What to Do'),
            c.default.createElement(
              f.default,
              null,
              'Now that the hardware knows what to do with your commands, let’s set up a new Node project within a random directory and install',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'https://github.com/rwaldron/johnny-five' },
                'the library'
              ),
              ' ',
              'we’re going to use to communicate with the device:'
            ),
            c.default.createElement(
              k.Code,
            ...
            c.default.createElement(
              f.default,
              null,
              'To accomplish this, you take one out of the Starter Kit and put the short part into the pin with the ',
              c.default.createElement('b', null, 'number 13'),
              ' and the long part into the pin named ',
              c.default.createElement('b', null, '“GND”'),
              ' right above the another one.'
            ),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(
              f.default,
              null,
              'Ready? Great! Then let’s ',
              c.default.createElement('b', null, 'run the program'),
              ' using Node and see what happens with our micro controller...'
            ),
            c.default.createElement(
              k.Code,
              { language: 'bash', syntax: a.default },
            ...
            c.default.createElement(y.H2, null, 'Finding Help'),
            c.default.createElement(
              f.default,
              null,
              'The accessibility of the documentation material is one of the key parts of an awesome community. Thankfully, the girls and guys who’ve contributed to Johnny Five have set up a complete website for the project that shows many',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'http://johnny-five.io/examples/' },
                'examples'
              ),
              ', as well as a full-blown',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'http://johnny-five.io/api/' },
                'API documentation'
              ),
              ' ',
              'for the library.'
            ...
            c.default.createElement(
              f.default,
              null,
              'And if a problem occurs that you’re not able to figure out by yourself, simply ask for help on their',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'https://gitter.im/rwaldron/johnny-five' },
              ...
              c.default.createElement(
                b.default,
                {
                  href: 'https://twitter.com/rwaldron/status/740673599246376960'
                },
                'so kind'
              ),
              '!'
            ...
            c.default.createElement(
              f.default,
              null,
              'If you’ve discovered a bug, also make sure to tell them by adding an issue on the',
              ' ',
              c.default.createElement(
                b.default,
                { href: 'https://github.com/rwaldron/johnny-five' },
              ...
              ' ',
              'or opening a pull request. The more people are helping out with their knowledge, the easier, faster and better it gets!'
            )
          )
        }
      },

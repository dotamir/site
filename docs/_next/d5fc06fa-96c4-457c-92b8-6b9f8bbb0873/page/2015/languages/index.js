window.__NEXT_REGISTER_PAGE('/2015/languages', function() {
        ...
        t.default = function() {
          return l.default.createElement(
            ...
            l.default.createElement(
              s.default,
              null,
              'Every language is beautiful. Currently, there are over',
              ' ',
              l.default.createElement('b', null, '3.500'),
              ' ',
              'languages spoken across the world. And in my view, we should keep ',
              l.default.createElement('b', null, 'all of them'),
              '. As humans — especially designers and developers, we often tend to make everything as perfect and easy as possible.'
            ),
            l.default.createElement(
              s.default,
              null,

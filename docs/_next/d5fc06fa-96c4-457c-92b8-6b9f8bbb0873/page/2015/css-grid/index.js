window.__NEXT_REGISTER_PAGE('/2015/css-grid', function() {
        ...
        o.default = function(l, o) {
          return function(e) {
            ...
            var R = a.hljs || { backgroundColor: '#fff' },
              I = p
                ? (0, d.default)({}, D, { style: (0, d.default)({}, R, j) })
                : (0, d.default)({}, D, { className: 'hljs' }),
              q = W ? i(L, E) : L.value,
              X = v
      ...
      12: function(l, o, e) {
        ...
        function a(l) {
          ...
          if (u) {
            var m = s(e, n),
              p = n
                ? { style: r(d.className, (0, i.default)({}, d.style, a), e) }
        ...
        function a(l, o, e, t, c) {
          ...
          try {
            for (
              ...
              (L = s(o.substring(D, R.index), R[0])),
                (D = M.terminators.lastIndex = R.index + L),
          ...
          function o(r, c) {
            ...
            r.compiled ||
              ...
              (a = r.contains
                ...
                .map(t)
                .filter(Boolean)),
              (r.terminators = a.length ? e(a.join(A), !0) : { exec: d }))
          }
          function e(o, e) {
      ...
      14: function(l, o, e) {
        !(function(l) {
          ...
          function n(l, t, r) {
            ...
            for (var i = 0, h = '', j = []; l.length || t.length; ) {
              var d = c()
              if (
                ((h += o(r.substring(i, d[0].offset))),
                (i = d[0].offset),
                d === l)
              ) {
                j.reverse().forEach(a)
          ...
          function j(l, e, r, c) {
            ...
            function b() {
              ...
              for (
                ...
                (r += o(x.substring(e, t.index))),
                  (l = i(w, t)),
                  l ? ((E += l[1]), (r += f(l[0], o(t[0])))) : (r += o(t[0])),
                  (e = w.lexemesRe.lastIndex),
                  (t = w.lexemesRe.exec(x))
              return r + o(x.substr(e))
            }
            function u() {
              var l = 'string' == typeof w.subLanguage
              if (l && !_[w.subLanguage]) return o(x)
              var e = l
                ? j(w.subLanguage, x, !0, A[w.subLanguage])
                : d(x, w.subLanguage.length ? w.subLanguage : void 0)
              return (
              ...
              if (e)
                return (
                  e.skip
                    ...
                    : (e.excludeBegin && (x += o),
                      g(),
                      e.returnBegin || e.excludeBegin || (x = o)),
                  m(e, o),
      ...
      516: function(l, o, e) {
        ...
        o.default = function() {
          return c.default.createElement(
            a.default,
            null,
            c.default.createElement(j.default, { id: 'css-grid' }),
            c.default.createElement(
              ...
              c.default.createElement(
                f.default,
                { href: 'http://bit.ly/2iQvY4g' },
                'post'
              ),
              ' ',
              'on Designer News that was created by a guy that wanted to create another flexbox-based grid framework for CSS. He probably knew that there are already many of them out there. But that didn',
              "'",
              't held him back from asking for interest in another one.'
            ),
            c.default.createElement(
              i.default,
              null,
              'The reason behind that is for sure that he just likes coding and also sees a thin gap for really great grid frameworks. Because I want people to stay motivated on their idea (no matter how many other guys already made it happen), I generally think it',
              "'",
              's not a bad idea to create another one. ',
              c.default.createElement('b', null, 'BUT'),
              ' only if he',
              "'",
              's doing it for the purpose of learning and not for other people. 😉'
            ),
            c.default.createElement(
              i.default,
              null,
              c.default.createElement('b', null, 'Why?'),
              ' Because the need for those kinds of frameworks will soon be gone forever. — Okay, that might be a bit confusing for you know, so let',
              "'",
              's start with a quick explanation:'
            ),
            c.default.createElement(
              i.default,
              null,
              'I don',
              "'",
              't know how you do it, but since a few years I have been using grid frameworks to align content properly and create responsive web layouts. With the time, a couple of aspects on the initial idea have changed: Websites are now mostly being designed mobile-first (fortunately) and flexbox allowed us to reach our goal of creating a effective CSS-layout more quickly by providing us with properties that can help us to equate the height of columns lined up in a row without knowing their content',
              "'",
              's size or using a mushy JS mixture that does this job.'
            ),
            c.default.createElement(
              i.default,
              null,
              'Until now, this was pretty much the best way to create a proper website layout (without writing a custom grid of course). Fortunately, we',
              "'",
              're now finally getting redeemed from this heavy performance load - thanks to ',
              c.default.createElement(b.InlineCode, null, 'grid'),
              '.'
            ),
            c.default.createElement(u.H2, null, "What's So Good about It?"),
            c.default.createElement(
              i.default,
              null,
              'It',
              ...
              c.default.createElement(
                f.default,
                { href: 'http://www.w3.org/TR/css-grid-1/' },
                'new CSS method'
              ),
              ' ',
              'that allows us to easily create beautiful web-layouts without a huge grid framework. No matter how tiny the budget of the client and how short your available time will be,',
              ' ',
              c.default.createElement(b.InlineCode, null, 'grid'),
              ' ',
              'provides you with many different properties which tell the browser how to position an element within the design.'
            ),
            c.default.createElement(
              i.default,
              null,
              'And the best thing about that: It seems like the browser just doesn',
              "'",
              't care about the position of the element within the HTML code. For example, a column that you want to show on the top right edge of the browser window can be placed right before the body tag closes (after all other elements).'
            ),
            c.default.createElement(
              i.default,
              null,
              ...
              ' ',
              c.default.createElement(b.InlineCode, null, 'position: absolute'),
              ' ',
              'but without needing to specify the position of the element with pixels. ',
              c.default.createElement(
                'i',
                null,
                'The grid will figure it out by itself.'
              ),
              ' — W3C describes this behaviour as',
              ' ',
              c.default.createElement(
                f.default,
                {
                  href: 'http://www.w3.org/TR/css-grid-1/#source-independence'
                },
                'source-order independence'
              ),
              '.'
            ),
            c.default.createElement(u.H2, null, 'Browser Support'),
            c.default.createElement(
              i.default,
              null,
              'Because it',
              "'",
              's a pretty new technology, there',
              "'",
              's currently only one browser that supports it by default: You won',
              "'",
              't believe me if I tell you ... *laughs* ... I just ... okay, it',
              "'",
              's our always beloved friend, the Internet Explorer. But no worries, you won',
              "'",
              't completely sink into confusion here: You still need to use the ',
              c.default.createElement(b.InlineCode, null, '-ms'),
              ' prefix. Now it makes a bit more sense, right? *laughs*'
            ),
            c.default.createElement(
              i.default,
              null,
              'Anyway. If you don',
              "'",
              't use IE (*shame on you*) you',
              "'",
              're also able to enable it through the ',
              '"',
              'experimental Web Platform features',
              '"',
              ' flag in ',
              c.default.createElement(b.InlineCode, null, 'chrome://flags'),
              ' within Chrome or Opera.'
            ),
            c.default.createElement(
              u.H2,
              null,
            ...
            c.default.createElement(
              i.default,
              null,
              c.default.createElement('b', null, 'No!'),
              ' — Don',
              "'",
              't start running and yelling ',
              "'",
              'Fuck you flexbox',
              "'",
              ' around in your office, WE STILL NEED IT!'
            ),
            c.default.createElement(
              i.default,
              null,
              'Those two properties are meant to be used for two completely different cases. The first -',
              ' ',
              c.default.createElement(b.InlineCode, null, 'display: grid'),
              ' ',
              '- can be used to create the general layout of your web- app or -site but not to align the ',
              '"',
              'boxes',
              '"',
              ' that contain the content. This is where `display: flex` claims your attention. It should be used to put all columns in one row to the same height for example.'
            ),
            c.default.createElement(
              i.default,
              null,
              'Okay, let',
              "'",
              's sum up for which each property should be used:'
            ),
            c.default.createElement(
              g.UL,
              null,
              c.default.createElement(
                g.LI,
                null,
                c.default.createElement('b', null, 'grid:'),
                ' — Layout'
              ),
              c.default.createElement(
                g.LI,
                null,
                c.default.createElement('b', null, 'flex:'),
                ' — Content'
              )
            ),
            c.default.createElement(
              ...
              'I think that',
              "'",
              's pretty easy to understand, isn',
              "'",
              't it? 😸'
            ),
            c.default.createElement(
              i.default,
              null,
              'So what are you waiting for? Open Chrome, enable that experimental flag and try the shit out of',
              ' ',
              c.default.createElement(b.InlineCode, null, 'grid'),
              '! If you get stuck or simply want to know more about how the property exactly works and how it should be used, take a look at the',
              ' ',
              c.default.createElement(
                f.default,
                { href: 'http://www.w3.org/TR/css-grid-1/' },
            ...
            c.default.createElement(
              i.default,
              null,
              'There are much more use cases for it to discover and we should all participate in it',
              "'",
              's development. I think it',
              "'",
              's a really huge step into the direction of a world that',
              "'",
              's free of performance- and memory-draining CSS frameworks.'
            )
          )
        }
      },

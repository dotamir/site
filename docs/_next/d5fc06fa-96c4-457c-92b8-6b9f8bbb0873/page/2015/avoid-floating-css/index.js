window.__NEXT_REGISTER_PAGE('/2015/avoid-floating-css', function() {
    ...
    [7],
    {
                  ...
                  contains: [
                    {
                      ...
                      contains: [
                        { className: 'built_in', begin: /[\w-]+/ },
                        {
                          ...
                          contains: [l.APOS_STRING_MODE, l.QUOTE_STRING_MODE]
                        }
                      ]
                    },
                    l.CSS_NUMBER_MODE,
          ...
          return {
            ...
            contains: [
              ...
              },
              {
                ...
                illegal: /\S/,
                contains: [l.C_BLOCK_COMMENT_MODE, o]
              }
            ]
          }
        }
      ...
      13: function(l, o, e) {
        ...
        function a(l, o, e, t, c) {
          function s(l, o) {
            var e, t, r
            if (((T += l), void 0 === o)) return b(h(), N), 0
            if ((e = S(o, M)))
              return b(h(), N), n(e, o), e.returnBegin ? 0 : o.length
            if ((t = x(M, o))) {
              ;(r = M), r.returnEnd || r.excludeEnd || (T += o), b(h(), N)
              do {
                M.className && C(), (U += M.relevance), (M = M.parent)
              } while (M !== t.parent)
              return (
                r.excludeEnd && g(o, N),
                (T = k),
          ...
          function j() {
            ...
            return o && !O[M.subLanguage]
              ? g(T, [])
              : ((l = o
                  ? a(M.subLanguage, T, !0, t, q[M.subLanguage])
                  : r(T, {
                      subset: M.subLanguage.length ? M.subLanguage : void 0,
                      prefix: t
                    })),
                M.relevance > 0 && (U += l.relevance),
          ...
          function u() {
            var l,
              ...
              t,
              r = []
            if (!M.keywords) return g(T, r)
            for (l = 0, M.lexemesRe.lastIndex = 0, o = M.lexemesRe.exec(T); o; )
              g(T.substring(l, o.index), r),
                (t = w(M, o)),
                t
                  ? ((U += t[1]),
                    (e = v(t[0], [])),
                ...
                (o = M.lexemesRe.exec(T))
            return g(T.substr(l), r), r
          }
          function b(l, o) {
            for (var e, t = l.length, r = -1; ++r < t; )
              (e = l[r]), e.type === E ? g(e.value, o) : o.push(e)
          }
          function g(l, o) {
            var e
            return (
              l &&
                ((e = o[o.length - 1]),
                e && e.type === E ? (e.value += l) : o.push(p(l))),
              o
            )
          }
          function p(l) {
          ...
          if (((P = f(l)), (B = M = c || P), (N = L = []), !P))
            throw new Error('Unknown language: `' + l + '` is not registered')
          i(P)
          try {
            for (
              D = M.terminators.lastIndex = 0, R = M.terminators.exec(o);
              R;

            )
              (I = s(o.substring(D, R.index), R[0])),
                (D = M.terminators.lastIndex = R.index + I),
                (R = M.terminators.exec(o))
            for (s(o.substr(D)), B = M; B.parent; )
              B.className && C(), (B = B.parent)
            return { relevance: U, value: N, language: l, top: M }
          } catch (l) {
          ...
          function o(r, c) {
            function s(o, e) {
              ...
              for (
                ...
                (r = t[c].split(_)), (i[r[0]] = [o, r[1] ? Number(r[1]) : 1])
            }
            var a,
              i = {}
            r.compiled ||
              ...
              (a = r.contains
                ...
                .map(t)
                .filter(Boolean)),
              (r.terminators = a.length ? e(a.join(_), !0) : { exec: j }))
          }
          function e(o, e) {
      ...
      14: function(l, o, e) {
        !(function(l) {
          ...
          function d(l, e, r, c) {
            ...
            function u() {
              var l, e, t, r
              if (!w.keywords) return o(W)
              for (
                r = '',
                  e = 0,
                  w.lexemesRe.lastIndex = 0,
                  t = w.lexemesRe.exec(W);
                t;

              )
                (r += o(W.substring(e, t.index))),
                  (l = i(w, t)),
                  l ? ((x += l[1]), (r += f(l[0], o(t[0])))) : (r += o(t[0])),
                  (e = w.lexemesRe.lastIndex),
                  (t = w.lexemesRe.exec(W))
              return r + o(W.substr(e))
            }
            function b() {
              var l = 'string' == typeof w.subLanguage
              if (l && !A[w.subLanguage]) return o(W)
              var e = l
                ? d(w.subLanguage, W, !0, _[w.subLanguage])
                : j(W, w.subLanguage.length ? w.subLanguage : void 0)
              return (
                w.relevance > 0 && (x += e.relevance),
                l && (_[w.subLanguage] = e.top),
                f(e.language, e.value, !1, !0)
              )
            }
            function g() {
              ;(E += null != w.subLanguage ? b() : u()), (W = '')
            }
            function m(l) {
              ;(E += l.className ? f(l.className, '', !0) : ''),
                (w = Object.create(l, { parent: { value: w } }))
            }
            function p(l, o) {
              if (((W += l), null == o)) return g(), 0
              var e = s(o, w)
              if (e)
                return (
                  e.skip
                    ...
                    : (e.excludeBegin && (W += o),
                      g(),
                      e.returnBegin || e.excludeBegin || (W = o)),
                  m(e, o),
            ...
            for (v = w; v !== y; v = v.parent)
              v.className && (E = f(v.className, '', !0) + E)
            var W = '',
              x = 0
            try {
              for (var O, P, M = 0; ; ) {
                if (
                  ...
                  break
                ;(P = p(e.substring(M, O.index), O[0])), (M = O.index + P)
              }
              for (p(e.substr(M)), v = w; v.parent; v = v.parent)
                v.className && (E += S)
              return { relevance: x, value: E, language: l, top: w }
            } catch (l) {
          ...
          function f(l) {
            return C.tabReplace || C.useBR
              ? l.replace(O, function(l, o) {
                  return C.useBR && '\n' === l
                    ? '<br>'
                    : C.tabReplace ? o.replace(/\t/g, C.tabReplace) : ''
                })
              : l
          }
          function u(l, o, e) {
          ...
          function k(l) {
            return (l = (l || '').toLowerCase()), A[l] || A[E[l]]
          }
          var w = [],
            _ = Object.keys,
            A = {},
      ...
      511: function(l, o, e) {
        ...
        var r = e(0),
          ...
          v = e(95),
          k = t(v),
          w = { 'text-decoration': 'overline' }
        o.default = function() {
          return c.default.createElement(
            d.default,
            null,
            c.default.createElement(b.default, { id: 'avoid-floating-css' }),
            c.default.createElement(
              f.default,
              null,
              'Do we still need to use it? Yes, the',
              ' ',
              c.default.createElement(p.InlineCode, null, 'float'),
              ' ',
              'property has been here for a really long time. I guess most of us used it for galleries, navigations and maybe also grids. But let',
              "'",
              's be honest with ourselves, it',
              "'",
              's a very uncomfortable way to align items one-after-another.'
            ),
            c.default.createElement(
              f.default,
              null,
              'Firstly, there',
              "'",
              's this whole problem that the parent element of the aligned items will break down like an old house that',
              "'",
              's currently being demolished by a demolition crane. ',
              c.default.createElement(
                'i',
                null,
                'Okay, I',
                "'",
                'm digressing a bit, let',
                "'",
                's move on.'
              ),
              ' So why are we still using it? I mean, pushing an inline image to the side and letting other elements (like paragraphs) flow around it is still a great use-case. But it clearly generates to much hassle in the end, if you ask me - you need to take care of too much other aspects like clearing floats and making sure they don',
              "'",
            ...
            c.default.createElement(
              f.default,
              null,
              'The answer is: No, we don',
              "'",
              't need to use this method for columns within content-areas anymore, there are some other alternatives which are way more easy to use and therefore create much less pain while developing. Until now, many web-developers might have argued with the fact that property-values like',
              ' ',
              c.default.createElement(p.InlineCode, null, 'flex'),
              ' ',
              'are were badly supported by browsers. But this time is over, every major browser encourages you to use it now.'
            ),
            c.default.createElement(
              f.default,
              null,
              'If you',
              "'",
              're also tired of floating elements and want to try out something new, continue reading. If not, you',
              "'",
              're completely free to leave this page.'
            ),
            c.default.createElement(
              f.default,
              null,
              'Alright gentlemen, then start your engines now! Thanks to the cool people who are contributing to the web standards, I',
              "'",
              'm now able to show you a few other methods for aligning items that are much less pain-in-the-ass and also way easier to use.'
            ),
            c.default.createElement(y.H2, null, 'Flexbox'),
            c.default.createElement(
              f.default,
              null,
              'Firstly, there',
              ...
              's ',
              c.default.createElement(p.InlineCode, null, 'flex'),
              ' - I told you about it earlier. It',
              "'",
              's a convenient manner that allows you to position elements with different sizes easily by providing maximum and minimum widths or heights for example. It will also bring other sub-properties which are able to calculate the size of an item in dependence of the other ones around it.'
            ),
            c.default.createElement(
              m.default,
              ...
              "'",
              ' ',
              'width or height in order to best fill the available space...'
            ),
            c.default.createElement(
              f.default,
              null,
              'The problem with our current box model is that we',
              "'",
              're theoretically not able to set three elements to the exact same width, for example. For this, you would technically need to set a width of 33,',
              c.default.createElement('span', { style: w }, '3'),
              '% for each of them (100% divided into 3 columns), and it',
              "'",
              's neither possible to set periodical numbers in CSS, nor is it useful. Sure, there',
              "'",
              's a practical solution for that:'
            ),
            c.default.createElement(
              f.default,
              null,
              'Browsers are built to figure things like this out and close the gap between theory & practice. They will always size the items until they',
              "'",
              're completely equally of width. But in my view, that',
              "'",
              's just a messy solution and not stable for the future. And yes, that',
              "'",
              's where',
              ' ',
              c.default.createElement(p.InlineCode, null, 'flex'),
            ...
            c.default.createElement(
              f.default,
              null,
              'There are a few more things that I especially like on this property, everything is less confusing with it. For example, the container',
              "'",
              's margins don',
              "'",
              't collapse with the margins of its child elements. And even better: The parent element doesn',
              "'",
              't suddenly loose it',
              "'",
              's height and the display-order of it',
              "'",
              's children is completely independent of their order in the source code.'
            ),
            c.default.createElement(
              f.default,
              null,
              'To start using this method now, just try it',
              "'",
              's easy syntax and add the following to the parent element:'
            ),
            c.default.createElement(
              p.Code,
              { language: 'css', syntax: a.default },
              'display: -webkit-flex;\ndisplay: block;'
            ),
            c.default.createElement(
              f.default,
              null,
              'For the first steps, there',
              "'",
              's absolutely no need to add attributes to the child items. They will magically start reacting to this change and will immediately line up one after another. If the content elements of the container aren',
              "'",
              't modified in any other way, it will look like this:'
            ),
            ...
            c.default.createElement(
              f.default,
              null,
              'But beware, there are many other cool properties like ',
              c.default.createElement(p.InlineCode, null, 'justify-content'),
              ' (which I also used to center the items in this preview),',
              ' ',
              c.default.createElement(p.InlineCode, null, 'align-self'),
              ' ',
              'and',
              ' ',
              c.default.createElement(p.InlineCode, null, 'order'),
              '. If you want to learn more about how to exactly use them, take a glimpse on Mozilla',
              "'",
              's',
              ' ',
              c.default.createElement(
              ...
              ' ',
              '(the other related properties are shown on the left there).'
            ),
            c.default.createElement(
              f.default,
              null,
              'However, watch out! In the current state of art, the ',
              c.default.createElement(p.InlineCode, null, 'flex'),
              ' property is supported on most browsers (like I already said), but you still need to use prefixes when firing it up in Chrome or Safari for example. The confusing thing about that is that the main property wants you to insert the prefix within the value (',
              c.default.createElement(p.InlineCode, null, '-webkit-flex'),
              ') and not before the key (just take a look on the code example up there). All other properties can generally be prefixed as usual (e.g. ',
              c.default.createElement(
                p.InlineCode,
                null,
            ...
            c.default.createElement(y.H2, null, 'Blocks, but InlineCode'),
            c.default.createElement(
              f.default,
              null,
              'Yes, that',
              "'",
              's kind of a weird heading but describes exactly what I want to talk about now: The',
              ' ',
              c.default.createElement(p.InlineCode, null, 'inline-block'),
              ' ',
              'value used in combination with the',
              ' ',
              c.default.createElement(p.InlineCode, null, 'display'),
              ' ',
              'property. Sure, you might already now about it ',
              c.default.createElement(
                'i',
                null,
                '(What am I talking about, of course you do...)'
              ),
              ', but have you ever thought about using it as an alternative for aligning columns? I mean, that',
              "'",
              's the use-case for which you perhaps needed floats before, right?'
            ),
            c.default.createElement(
              f.default,
              null,
            ...
            c.default.createElement(
              f.default,
              null,
              'When setting up a portion of clean HTML code, you',
              "'",
              'll probably make use of several great indention options to make the code easily readable. That means, you',
              "'",
              'll put each child element into a new line instead of writing them all successively. And that',
              "'",
              's great, please don',
              "'",
              't do it otherwise! However, this indention will generate irritating space-characters between the elements in the output — look here:'
            ),
            c.default.createElement(i.default, {
              user: 'mindrun',
            ...
            c.default.createElement(
              f.default,
              null,
              'But of course we neither need nor want them to show up. They',
              "'",
              're just completely useless when creating columns. To fix this issue, we need to set',
              ' ',
              c.default.createElement(p.InlineCode, null, 'font-size'),
              ' ',
              'to',
              ' ',
              c.default.createElement(p.InlineCode, null, '0'),
              ' ',
              'or put all items in one line within the code. Well, you might have already noticed it: That',
              "'",
              's also a hacky solution, isn',
              "'",
              't it? And not something that has been covered by the creators of this property, so it might also be inappropriate to use this value for columns (I guess that',
              "'",
              's were the opinions differ. Many people are arguing that this is something that can be overlooked without worries, other people might say it',
              "'",
              's clear that it',
              "'",
            ...
            c.default.createElement(
              ...
              'Anyway, don',
              "'",
              't hold yourself back from using it just because it needs some more adjustments to work properly (this are my 2 cents). We need to use things for different purposes other than they have been made for and try them out in various scenarios to find out what we',
              "'",
              're in need for and to push the web forward.'
            ),
            c.default.createElement(
              f.default,
              null,
              ...
              'value doesn',
              "'",
              't provide you with any other cool property which you could use to align the items in a special way. However, it allows you to treat the content elements like text when it comes to positioning (since they',
              "'",
              're displayed inline). For example, you can push them into the left or right edge or the middle by using ',
              c.default.createElement(p.InlineCode, null, 'text-align'),
              '. You could also use properties like',
              ' ',
              c.default.createElement(p.InlineCode, null, 'line-height'),
              ' ',
              'to equal the heights of all elements inside the container (that also depends on if they own padding, since it',
              "'",
              's extending the line-height).'
            ),
            c.default.createElement(
              f.default,
              null,
              'I',
              "'",
              'm sure the most of you already know everything about this value, since it',
              "'",
              's also being used for various other use-cases. But if you don',
              "'",
              't, read more about it',
              ' ',
              c.default.createElement(
                k.default,
                {
              ...
              ' ',
              '(the official documentations are not really helpful now, since they',
              "'",
              're too abstract for you, I guess).'
            ),
            c.default.createElement(y.H2, null, 'Conclusion'),
            c.default.createElement(
              f.default,
              null,
              'My indention behind this article was clearly not to provide you with a complete guide on how to use those properties. It was rather a collection of recommondations you could use instead of the old floating-method. If I inspired you to think about these alternatives, I',
              "'",
              'm happy.'
            ),
            c.default.createElement(
              f.default,
              null,
              'What you should also remember is that these properties have initially been designed to provide easy solutions for creating columns within a content-area (at least that',
              "'",
              's what I heard from other people and what my experiences told me) and not for creating complete layouts (you should use ',
              c.default.createElement(
                k.default,
                { href: '/2015/css-grid' },
                'grids'
              ...
              ' for this). And yes, I',
              "'",
              'm talking of the future. Currently, you would probably need to use those properties for layouting too, because',
              ' ',
              c.default.createElement(p.InlineCode, null, 'grid'),
              ' ',
              'isn',
              "'",
      ...
      512: function(l, o, e) {
        ...
        var t = e(0),
          ...
          c = r.default.createClass({
            displayName: 'Codepen',
            propTypes: {
              user: r.default.PropTypes.string.isRequired,
              hash: r.default.PropTypes.string.isRequired,
              height: r.default.PropTypes.string,
              width: r.default.PropTypes.string,
              tab: r.default.PropTypes.oneOf(['html', 'css', 'result', 'js']),
              theme: r.default.PropTypes.string
            },
            ...
            render: function() {
              var l =
                  ...
                  '&default-tab=' +
                  this.props.tab,
                o = 'http://codepen.io/' + this.props.user,
                e = o + '/pen/' + this.props.hash + '/'
              return r.default.createElement(
                ...
                r.default.createElement('a', { href: e }, 'See this pen'),
                ' by ',
                this.props.user,
                ' (',
                r.default.createElement('a', { href: o }, '@', this.props.user),
                ') on ',
        ...
        ;(o.default = c), (l.exports = o.default)
      },
      52: function(l, o, e) {
        'use strict'
        Object.defineProperty(o, '__esModule', { value: !0 }),

    ...
    [1],
    {
      ...
      41: function(l, o, e) {
        ...
        var r = e(3),
          ...
          h = function(l, o) {
            var e = []
            return l && e.push('cover'), o && e.push('frame'), e.join(' ')
          },
          j = function(l) {
            var o = l.src,
              e = l.width,
              t = l.height
            if (!e || !t) throw new Error('Please define the height and width')
            var r = t / e * 100,
              s = { paddingBottom: r + '%' }
            return a.default.createElement(
              'aside',
              { style: s, className: 'jsx-758104230' },
          ...
          d = function(l) {
            ...
            return a.default.createElement(
              'figure',
              { className: 'jsx-1922582570 ' + (h(t, r) || '') },
          ...
          return function(e) {
            ...
            return g.default.createElement(
              ...
              g.default.createElement(
                M,
                b,
                O({ rows: X, stylesheet: a, useInlineStyles: p })
              )
            )
          }
        }
        ...
        function a(l) {
          ...
          if (b) {
            var m = s(e, n),
              ...
              y = m(o.children)
            return f.default.createElement(b, (0, j.default)({ key: h }, p), y)
          }
        }
        Object.defineProperty(o, '__esModule', { value: !0 })
        var n = e(29),
      ...
      492: function(l, o, e) {
        ...
        function s(l, o) {
          var e = (O[l] = o(b)),
            ...
            r = t && t.length,
            c = -1
          for (W.push(l); ++c < r; ) S[t[c]] = l
        }
        function a(l, o, e, t, c) {
          function s(l, o) {
            var e, t, r
            if (((U += l), void 0 === o)) return b(h(), B), 0
            if ((e = S(o, M)))
              return b(h(), B), n(e, o), e.returnBegin ? 0 : o.length
            if ((t = W(M, o))) {
              ;(r = M), r.returnEnd || r.excludeEnd || (U += o), b(h(), B)
              do {
          ...
          function h() {
            var l = void 0 === M.subLanguage ? u() : d()
            return (U = k), l
          }
          function d() {
            var l,
          ...
          function b(l, o) {
            for (var e, t = l.length, r = -1; ++r < t; )
              (e = l[r]), e.type === A ? g(e.value, o) : o.push(e)
          }
          function g(l, o) {
            var e
            return (
              l &&
                ((e = o[o.length - 1]),
                e && e.type === A ? (e.value += l) : o.push(p(l))),
              o
            )
          }
          function p(l) {
          ...
          function W(l, o) {
            ...
            if (l.endsWithParent) return W(l.parent, o)
          }
          function S(l, o) {
        ...
        !(function(l) {
          ...
          function j(l, e, r, c) {
            ...
            function b() {
              ...
              if (l && !x[w.subLanguage]) return o(E)
              var e = l
                ? j(w.subLanguage, E, !0, _[w.subLanguage])
                : d(E, w.subLanguage.length ? w.subLanguage : void 0)
              return (
                w.relevance > 0 && (W += e.relevance),
                l && (_[w.subLanguage] = e.top),
                f(e.language, e.value, !1, !0)
              )
            }
            function g() {
              ;(A += null != w.subLanguage ? b() : u()), (E = '')
            }
            function m(l) {
            ...
            try {
              ...
              for (p(e.substr(M)), v = w; v.parent; v = v.parent)
                v.className && (A += S)
              return { relevance: W, value: A, language: l, top: w }
            } catch (l) {
          ...
          function k(l) {
            return (l = (l || '').toLowerCase()), x[l] || x[A[l]]
          }
          var w = [],
            _ = Object.keys,
            x = {},
